...
pacman::p_load(shiny,tictoc,DT,data.table,tidyverse,shinythemes,skimr,htmlTable,RColorBrewer,tools,ggpubr,shinybusy,shinyjs,ggbeeswarm,ggplotify,rjson,shinyBS)
...
processVarsOptions = c("Intensity Sum Normalised per Nucleus",
                       "Intensity Mean Normalised per Nucleus",
                       "Intensity StdDev Normalised per Nucleus",
